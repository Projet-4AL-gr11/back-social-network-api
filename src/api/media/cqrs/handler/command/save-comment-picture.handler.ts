...
export class SaveCommentPictureHandler
  implements ICommandHandler<SaveCommentPictureCommand>
{
  constructor(
  ...
  async execute(command: SaveCommentPictureCommand): Promise<Media> {
    try {
      const s3 = new S3();

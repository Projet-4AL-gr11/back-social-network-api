...
export class LeaderboardController {
    ...
    async getLeaderboardForUserWithExerciseId(
        ...
        return await this.leaderboardService.getLeaderboardForUserWithExerciseId(id, exerciseId);
    }


    @Post()
    async create(@Body() createLeaderboardDto: CreateLeaderboardDto): Promise<Leaderboard> {
